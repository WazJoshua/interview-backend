...
public class CreateActivationCodeRequestValidator
        implements ConstraintValidator<ValidActivationCodePayload, CreateActivationCodeRequest> {

    @Override
    public boolean isValid(CreateActivationCodeRequest value, ConstraintValidatorContext context) {
